...
ENV_SCHEMA = [
    ...
    {"group": "IPMart 每账号代理", "items": [
        {"key": "IPMART_ENABLED", "type": "choice", "choices": ["0", "1"], "default": "0",
         "help": "设为 1 后，每轮注册获取一个新的 HTTP 代理；不会回退到 Clash。"},
        {"key": "IPMART_ACCESS_KEY", "secret": True,
         "help": "IPMart API accessKey。启用前需在 IPMart 后台添加本机公网 IP 白名单。"},
        {"key": "IPMART_API_BASE", "default": "https://api.ipmart.io/ipmart/common/getIps",
         "help": "IPMart API 地址。"},
        {"key": "IPMART_COUNTRY", "default": "US", "help": "代理国家代码。"},
        {"key": "IPMART_STICKY_MINUTES", "type": "int", "default": 30,
         "help": "代理粘性时间（5-30 分钟）。"},
        {"key": "IPMART_MAX_ATTEMPTS", "type": "int", "default": 3,
         "help": "获取或验证失败时的最大尝试次数。"},
        {"key": "IPMART_IP_CHECK_URL", "default": "https://api.ipify.org?format=json",
         "help": "通过代理验证真实出口 IP 的地址。"},
    ]},
